...
class Settings(BaseSettings):
    ...
    telegram_sync_batch_pause_seconds: float = Field(default=1.5, ge=0.1, le=30)
    ...
    scheduler_poll_interval_seconds: float = Field(default=60, ge=1, le=300)
    ...
    worker_heartbeat_seconds: float = Field(default=30.0, ge=1, le=300)
    client_bot_sync_interval_seconds: float = Field(default=10.0, ge=0.2, le=60)
    client_bot_heartbeat_seconds: float = Field(default=30.0, ge=1, le=300)
    client_bot_restart_backoff_seconds: float = Field(default=10.0, ge=0.2, le=300)
    telegram_runtime_reconcile_interval_seconds: float = Field(default=15.0, ge=2, le=300)
